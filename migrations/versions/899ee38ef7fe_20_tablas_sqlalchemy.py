"""20 tablas sqlalchemy

Revision ID: 899ee38ef7fe
Revises: 
Create Date: 2024-07-07 10:56:24.224546
...
def upgrade():
    ...
    sa.Column('estado_cliente', sa.String(length=80), nullable=False),
    sa.Column('estado', sa.Integer(), nullable=True),
